...
namespace Shane.Church.Utility
{
	public static class Imaging
	{
		...
		public static void SaveImage(WriteableBitmap wbm, string path, ImageType type)
		{
		...
		public static WriteableBitmap LoadImage(string path)
		{
			try
			{
				using (IsolatedStorageFile appStorage = IsolatedStorageFile.GetUserStoreForApplication())
			...
			{
				_logger.ErrorException("Error Loading Image", ex);
