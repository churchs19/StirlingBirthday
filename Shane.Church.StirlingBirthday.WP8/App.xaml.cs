...
namespace Shane.Church.StirlingBirthday.WP
{
    public partial class App : Application
    {
        ...
        async void rateReminder_ReminderClosed(object sender, ReminderClosedEventArgs e)
        {
            ...
            {
                var eArgs = await RadMessageBox.ShowAsync(buttonsContent: new List<object>() { Shane.Church.StirlingBirthday.Strings.Resources.GiveFeedbackButton, Shane.Church.StirlingBirthday.Strings.Resources.NoThanksButton },
                    title: Shane.Church.StirlingBirthday.Strings.Resources.FeedbackTitle,
                    message: Shane.Church.StirlingBirthday.Strings.Resources.FeedbackContent);

                if (eArgs.ButtonIndex == 0)
                {
                    EmailComposeTask emailTask = new EmailComposeTask();
                    emailTask.To = "shane@s-church.net";
                    emailTask.Subject = emailTask.Subject = Shane.Church.StirlingBirthday.Strings.Resources.TechnicalSupportEmailSubject;
                    emailTask.Show();
                }
            }
        }
        ...
        // 
        // Shane.Church.StirlingBirthday.Strings.Resources.es-ES.resx 
        //    ResourceLanguage's value should be "es-ES" 
        //    ResourceFlowDirection's value should be "LeftToRight" 
        // 
        // Shane.Church.StirlingBirthday.Strings.Resources.ar-SA.resx 
        ...
        private void InitializeLanguage()
        {
            try
            {
                ...
                // the resource file. 
                RootFrame.Language = XmlLanguage.GetLanguage(Shane.Church.StirlingBirthday.Strings.Resources.ResourceLanguage);
                ...
                // the resource file. 
                FlowDirection flow = (FlowDirection)Enum.Parse(typeof(FlowDirection), Shane.Church.StirlingBirthday.Strings.Resources.ResourceFlowDirection, false);
                RootFrame.FlowDirection = flow;

                //Initialiaze Telerik Localization Manager
                Telerik.Windows.Controls.InputLocalizationManager.Instance.ResourceManager = Shane.Church.StirlingBirthday.Strings.Resources.ResourceManager;
            }
            catch
            {
...
#if DEBUG
            MarkedUp.AnalyticClient.Initialize("ab4a22de-3878-4946-821b-b499cf6b03df");
#else
            MarkedUp.AnalyticClient.Initialize("412aaea1-d43e-43be-a26e-f78e85c82168");
#endif
